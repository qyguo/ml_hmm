...
input="/eos/user/q/qguo/vbfhmm/2022_v4_jetVeto/After_hadd/"
target="/eos/user/q/qguo/vbfhmm/ml/2022_v4_jetVeto/skimmed_ntuples/"
...
declare -A outName_Full=(
    ...
    ["GluGluHto2Mu_M-125_powheg_2022"]="GluGluHToMuMu_M125"
    ["VBFHto2Mu_M-125_powheg_2022"]="VBFHToMuMu_M125"
    ["Muon_UL22"]="data"
...
for key in "${!outName_Full[@]}"; do
    ...
    echo python ${script_Path}/skim_ntuples_Hmm_23.py -i ${input}/${key}.root -o ${target}/${value}.root -y 2022 >> skim_22_v4_jetVeto.sh 
done
