...
input="/eos/user/q/qguo/vbfhmm/2023BPix_v4_jetVeto/After_hadd/"
target="/eos/user/q/qguo/vbfhmm/ml/2023BPix_v4_jetVeto/skimmed_ntuples/"
...
declare -A outName_Full=(
    ...
    ["GluGluHto2Mu_M-125_powheg_2023BPix"]="GluGluHToMuMu_M125"
    ["VBFHto2Mu_M-125_powheg_2023BPix"]="VBFHToMuMu_M125"
    ["Muon01_23D_v12"]="data"
...
for key in "${!outName_Full[@]}"; do
    ...
    echo python ${script_Path}/skim_ntuples_Hmm_23.py -i ${input}/${key}.root -o ${target}/${value}.root -y 2023BPix >> skim_23BPix_v4_jetVeto.sh 
done
