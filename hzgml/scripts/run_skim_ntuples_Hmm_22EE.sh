...
input="/eos/user/q/qguo/vbfhmm/2022EE_v4_jetVeto/After_hadd/"
target="/eos/user/q/qguo/vbfhmm/ml/2022EE_v4_jetVeto/skimmed_ntuples/"
...
for key in "${!outName_Full[@]}"; do
    ...
    echo python ${script_Path}/skim_ntuples_Hmm_22EE.py -i ${input}/${key}.root -o ${target}/${value}.root >> skim_22EE_v4_jetVeto.sh 
done
