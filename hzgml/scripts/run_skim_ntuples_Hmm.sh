...
input="/eos/user/q/qguo/vbfhmm/UL18_checkV2/After_hadd/"
target="/eos/user/q/qguo/vbfhmm/ml/2018/skimmed_ntuples_v4/"
...
declare -A outName_Full=(
    ...
    ["tZq_ll_4f_ckm_NLO-madgraph_RunIIAutumn18_ext1-v1"]="tZq"
    ["GluGluHToMuMu_M125-powheg_20UL18"]="GluGluHToMuMu_M125"
    ["VBFHToMuMu_M125-powheg_20UL18"]="VBFHToMuMu_M125"
    ["SingleMuon_UL18"]="data"
    ["DYJetsToLL_M-105To160_VBFFilter_TuneCP5_PSweights_13TeV-madgraphMLM_RunIIAutumn18"]="DY_105To160_VBFFilter"
    ["ZZTo4L_powheg_pythia8_20UL18"]="ZZTo4L"
    ["ZZTo2L2Nu_powheg_pythia8_20UL18"]="ZZTo2L2Nu"
    ["WWTo2L2Nu-powheg_20UL18"]="WWTo2L2Nu"
    ["WZTo3LNu-powheg_RunIIAutumn18_ext1-v1"]="WZTo3LNu"
    ["ZZTo2L2Q_13TeV_amcatnloFXFX_madspin_pythia8_RunIIAutumn18"]="ZZTo2L2Q"
    ["WZTo2L2Q_13TeV_amcatnloFXFX_madspin_pythia8_RunIIAutumn18"]="WZTo2L2Q"
)
...
for key in "${!outName_Full[@]}"; do
    ...
    echo python ${script_Path}/skim_ntuples_Hmm.py -i ${input}/${key}.root -o ${target}/${value}.root >> skim_UL18_v4_2.sh 
done
